...
"
            ...
            <h1 class="mb-8 lg:text-7xl md:text-6xl sm:text-4xl text-4xl lg:w-11/12 md:w-5/6 sm:w-3/4 text-white font-extrabold tracking-tight leading-none  dark:text-white tracking-wide relative  z-20 lg:leading-tight">
              We’re a web design agency from Los Angeles, CA
            </h1>
            <p class="space-grotesk text-white relative z-20 my-12 lg:w-3/5  lg:mb-20 xl:w-1/2  xl:mb-28 md:text-lg lg:text-lg dark:text-gray-400 tracking-wide">
          ...
          <img
            class="lg:absolute animate-fade-out md:mt-1  lg:w-7/12 lg:mt-20 lg:right-8 xl:mt-10 xl:w-6/12 xl:right-28 z-10"
            src={hero}
            alt="IntroImg"
          />
