...
const Footer = () => {
  return (
    <div>
      <footer class="space-grotesk p-4 bg-black sm:p-6 dark:bg-gray-800">
        <div class="relative mx-auto max-w-screen-xl">
          <div class="md:flex md:justify-between py-24">
            <div class="mb-6 md:mb-0 md:w-1/2 px-5">
              ...
              <img
                src={footercir}
                alt="Top Left Image"
                className="animate-fade-out absolute -left-28 bottom-16 lg:block hidden"
              />
              <img
                src={footercir2}
                alt="Top Left Image"
                className="animate-fade-out absolute h-44 -right-4 -top-4 lg:hidden block"
              />
            </div>
          ...
          <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm md:text-lg text-white sm:text-center dark:text-gray-400">
              © 2023 <a href="#">Sprint1</a>. All Rights Reserved.
            </span>
            <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
              <a
                href="#"
                class="text-white hover:text-violet-500 dark:hover:text-white"
              >
                <svg
