...
function Portfolio() {
  return (
    <div>
       <section class="text-gray-600 bg-black body-font mt-10 px-10">
       <div class="flex items-center ml-16 pt-96">
...
<h1 class="animate-fade-out ml-16 max-w-2xl mb-4 text-4xl text-white font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white tracking-wide leading-normal	lg:leading-loose
">Our recent clients</h1>
  <div class="animate-slide-in-up container mx-auto flex px-5 py-24 md:flex-row flex-col items-center ">
